    ...
    TInitialPowerLaw_ScalarPower =(this%As * exp(lnrat * (this%ns - 1 + lnrat * (this%nrun / 2 + this%nrunrun / 6 * lnrat)))) * ( 1 + this%ampt*Cos(this%freqt +this%phaset))
    ...
    call Ini%Read(CompatKey(Ini,'ampt'))
    call Ini%Read(CompatKey(Ini,'freqt'))
    call Ini%Read(CompatKey(Ini,'phaset'))
